...
var Render3D = (function () {
  ...
  // ---- input / fly camera ----
  var keys = {}, yaw = 0, pitch = -0.5, pointerLocked = false, speed = 40;
  ...
  function init(el, THREE) {
    ...
    document.addEventListener('pointerlockchange', function () { pointerLocked = document.pointerLockElement === renderer.domElement; });
  }
  ...
  function stop() { running = false; if (rafId) cancelAnimationFrame(rafId); keys = {}; if (document.pointerLockElement) document.exitPointerLock(); }
