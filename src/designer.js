...
(function () {
  ...
  function buildUI() {
    ...
    host.innerHTML =
      '<div class="row" style="margin:2px 0 10px"><strong style="font-size:15px">🎨 Design a map</strong>' +
      '<span class="dsnMini" style="margin-left:6px">paint a world → preview it in 3D → export it exactly, or find the closest real seed</span>' +
      ...
      '<div class="dsnCols">' +
        ...
        '</div>' +
        '<div class="dsnRight">' +
          // Primary path: exact authored world (+ 3D preview)
          '<div class="dsnCard"><h4 style="margin:0 0 4px">Your world <span class="dsnMini">— exact</span></h4>' +
            '<div class="dsnMini" style="margin:0 0 8px"><b>🧊 3D preview</b> flies through your design here. <b>Export</b> writes a bundle for the <code>EcoWorldGenCLI</code> tool → a stock-loadable <code>.eco</code> whose biomes + terrain match your drawing <b>exactly</b> (needs the C# tool + an Eco server build).</div>' +
          ...
          // Secondary path: closest naturally-generated world (seed search)
          '<div class="dsnSectionLbl">Or: find the closest <i>naturally-generated</i> world</div>' +
